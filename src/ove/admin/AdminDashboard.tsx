  ...
  return (
    <div>
      ...
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        ...
        <Col xs={12} md={6}>
          <Card>
            <Statistic title="Pendientes hoy" value={pending} prefix={<ClockCircleOutlined />} />
          </Card>
        </Col>
        <Col xs={12} md={6}>
          <Card>
        ...
        <Col xs={12} md={6}>
          <Card>
            <Statistic
              ...
              value={Math.round(
                seedAssets.reduce((sum, a) => sum + a.availability, 0) / seedAssets.length,
              )}
              suffix="%"
      ...
      <Row gutter={[16, 16]} style={{ marginTop: 16 }}>
        <Col xs={24} lg={16}>
          <Card
            title="Órdenes prioritarias del día"
            extra={
              <Button type="link" onClick={() => onNav("orders")}>
                  ...
                  actions={[
                    <Button
                      ...
                      onClick={() => {
                        setIncidents(
                          incidents.map((item) =>
                            item.id === i.id ? { ...item, status: "Resolved" } : item,
                          ),
                        );
